<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hospital_search.aspx.cs" Inherits="hospital_search" %>
    ...
    <div id="map-canvas" >
      <table>
        <tr id="url-row" class="table_row">
          <td id="icon" class="auto-style2"></td>
          <td id="url" class="table_row"></td>
        </tr>
        <tr id="address-row" class="table_row">
          <td class="auto-style1"></td>
          <td id="address" class="table_row"></td>
        </tr>
